...
type Simple struct {
	...
	Repeated      []string               `protobuf:"bytes,4,rep,name=Repeated,proto3" json:"Repeated,omitempty"`
...
var file_mocks_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x52, 0x65, 0x70, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09,
